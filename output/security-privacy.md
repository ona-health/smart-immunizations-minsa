# Seguridad y Privacidad - Guía de Implementación de Inmunizaciones MINSA Perú v1.0.0
...
Para un conjunto ilustrativo de requisitos no funcionales, que incluyen requisitos de seguridad y privacidad, consulte los [Requisitos No Funcionales](non-functional-requirements.md).
