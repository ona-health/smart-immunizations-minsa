# Indicadores y Medidas - Guía de Implementación de Inmunizaciones MINSA Perú v1.0.0
...
Los Measures incluidos en esta guía de implementación se listan en el [Índice de Artefactos - Measures](artifacts.md).

Para las descripciones operacionales de los indicadores y sus referencias, consulte el [Kit de Adaptación Digital de la OMS para Inmunizaciones](https://iris.who.int/handle/10665/380303). El contenido resumido de los indicadores adaptados al contexto peruano se presenta en la página de [Indicadores y Métricas de Desempeño](indicators.md).
