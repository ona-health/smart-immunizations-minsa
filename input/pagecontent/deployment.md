...
2. **Aplicación cliente**: Aplicación web progresiva (PWA) o aplicación nativa que permite la captura de datos con capacidad offline.
3. **Motor CQL**: Integrado en el servidor FHIR para la ejecución de la lógica de decisión y el cálculo de indicadores.
4. **Servicio de terminología**: Para la gestión centralizada de los catálogos de vacunas y códigos.
5. **Capa de interoperabilidad**: Para la integración con RENIEC, RENAES, HIS-MINSA y SIS.
...
2. **Fase de expansión regional**: Despliegue progresivo a las demás DIRESA/GERESA.
3. **Fase nacional**: Operación a escala nacional con integración completa con los sistemas del MINSA.
