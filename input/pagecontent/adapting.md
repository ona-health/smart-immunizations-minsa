...
2. **Adaptar las personas**: Ajustar los roles y competencias de las personas según la realidad del recurso humano en su jurisdicción.
3. **Personalizar terminología**: Agregar códigos locales si los sistemas de información regionales utilizan catálogos propios.
4. **Ajustar indicadores**: Incorporar indicadores adicionales requeridos por la DIRESA/GERESA local.
